...
const RunResults = ({loading, results} : codingAreaProps) => {
    const {darkTheme} = useContext(DarkThemeContext)
  return (
    <div className={`${darkTheme? "dark" :"light"} h-24 mt-5 mr-5 rounded-lg flex items-center px-5 justify-center gap-10`}>
